...
// Consulta para obter todas as salas, juntando dados dos blocos e pisos
$sql = "SELECT s.cod_sala, s.Nome_sala, s.Observações, s.Estado, 
               b.descricao_bloco, p.Descricao_piso
        FROM salas s
        JOIN blocos b ON s.Bloco_sala = b.cod_bloco
        JOIN pisos p ON s.Piso_sala = p.Cod_piso
        ORDER BY s.cod_sala ASC";
$stmt = $pdo->query($sql);
  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= ($sala['Estado'] == 1) ? 'Ativo' : 'Inativo' ?></td>
      </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
